...
$stats = [
    [
        ...
        'value' => '$124,563',
        'growth' => '+12.5%',
        'date' => 'vs Dec 01 - Dec 15',
        'icon' => 'ri-money-dollar-circle-line',
        'color' => 'green',
        'chart' => [20,40,35,60,45,80,70]
    ],
    [
        'title' => 'Active Users',
        'value' => '18,420',
            ...
            <div class="w-32 h-16">
                ...
                <svg viewBox="0 0 140 60" class="w-full h-full">
                    ...
                    <defs>
                        ...
                        <linearGradient id="lineGradient-{{ $loop->index }}" x1="0" y1="0" x2="1" y2="0">
                            <stop offset="0%" stop-color="{{ $currentColor['line'] }}" stop-opacity="0.4"/>
                            <stop offset="100%" stop-color="{{ $currentColor['line'] }}" stop-opacity="1"/>
                        </linearGradient>

                        <linearGradient id="areaGradient-{{ $loop->index }}" x1="0" y1="0" x2="0" y2="1">
                            <stop offset="0%" stop-color="{{ $currentColor['line'] }}" stop-opacity="0.25"/>
